...
we get $i \hbar  \frac{\partial}{\partial t} \psi= \sqrt{p_x^2c^2 + p_y^2 c^2 + p_z^2 c^2 m^2 c^4 }\psi$. However, the square root operator is non-local and difficult to work with.
...
\begin{align*}
    &i \hbar \frac{\partial}{\partial t} \psi = \left( c \alpha_x p_x + c \alpha_y p_y + c \alpha_z p_z + \beta mc^2 \right) \psi \quad 
