...
\begin{align*}
    \hat{\mathcal{U}}(t + dt, t_0) = \hat{\mathcal{U}}(t+ dt, t) \hat{\mathcal{U}}(t, t_0) = \left(1- \frac{i\hat{H}dt}{\hbar}\right)\hat{\mathcal{U}}(t, t_0).
\end{align*}
...
\underline{Equation of motion in Heisenberg picture:}

We can use the time evolution of an operator and the definition of an operator in the Heisenberg 
picture to find the equation of motion.
Starting from the definition of the Heisenberg operator, we have
\begin{align*}
    \hat{A}_H(t) = \hat{\mathcal{U}}^{\dagger}(t,t_0)\hat{A}_S \hat{\mathcal{U}}(t,t_0).
\end{align*}
Taking the time derivative of this equation, we get
\begin{align*}
    \frac{d}{dt} \hat{A}_H(t) = \frac{d\hat{\mathcal{U}}^{\dagger}(t,t_0)}{dt} \hat{A}_S \hat{\mathcal{U}}(t,t_0) + \hat{\mathcal{U}}^{\dagger}(t,t_0) \hat{A}_S \frac{d\hat{\mathcal{U}}(t,t_0)}{dt}.
\end{align*}
Using the Schrödinger equation for the time evolution operator, we have
\begin{align*}
    \frac{i}{\hbar} [ \hat{A}^{(H)}, \hat{\mathcal{U}}^{\dagger}\hat{H}\hat{\mathcal{U}} ].
\end{align*}
For the time evolution operator for time independent hamiltonian the two operators commute, and we get
\begin{align*}
    \frac{d}{dt} \hat{A}^{(H)} = \frac{i}{\hbar} [\hat{A}^{(H)}, \hat{H}].
\end{align*}
This is the Heisenberg equation of motion for an operator in the Heisenberg picture.
